...
{
	variable *var = variables_get_imageview(name, "zoomin");
...
{
	variable *var = variables_get_imageview(name, "zoomout");
...
{
	variable *var = variables_get_imageview(name, "zoomreset");
...
variable *variables_set_value(const char *name, const char *value)
{
	...
	switch (toset->Type) {
		...
		case WIDGET_STACK:
			...
			break;
		case WIDGET_LISTBOX:
			widget_listbox_fileselect(toset, name, value);
			break;
		case WIDGET_FLOWBOX:
			widget_flowbox_fileselect(toset, name, value);
			break;
		case WIDGET_PLACESSIDEBAR:
			widget_placessidebar_fileselect(toset, name, value);
			break;
		case WIDGET_MENUBUTTON:
			widget_menubutton_fileselect(toset, name, value);
			break;
		case WIDGET_OVERLAY:
		...
		case WIDGET_SEARCHBAR:
			widget_searchbar_fileselect(toset, name, value);
			break;
		case WIDGET_ACTIONBAR:
			widget_actionbar_fileselect(toset, name, value);
			break;
		case WIDGET_FILECHOOSERBUTTON:
			widget_filechooserbutton_fileselect(toset, name, value);
			break;
		case WIDGET_APPCHOOSERBUTTON:
			widget_appchooserbutton_fileselect(toset, name, value);
			break;
		case WIDGET_APPCHOOSER:
			widget_appchooser_fileselect(toset, name, value);
			break;
		case WIDGET_APPCHOOSERDIALOG:
			widget_appchooserdialog_fileselect(toset, name, value);
			break;
		case WIDGET_COLORCHOOSERDIALOG:
			widget_colorchooserdialog_fileselect(toset, name, value);
			break;
		case WIDGET_FONTCHOOSERDIALOG:
			widget_fontchooserdialog_fileselect(toset, name, value);
			break;
		case WIDGET_RECENTCHOOSERDIALOG:
			widget_recentchooserdialog_fileselect(toset, name, value);
			break;
		case WIDGET_SHORTCUTSWINDOW:
			widget_shortcuts_fileselect(toset, name, value);
			break;
...
variable *variables_save(const char *name)
{
	...
	switch (var->Type) {
		...
		case WIDGET_STACK:
			...
			break;
		case WIDGET_LISTBOX:
			widget_listbox_save(var);
			break;
		case WIDGET_FLOWBOX:
			widget_flowbox_save(var);
			break;
		case WIDGET_PLACESSIDEBAR:
			widget_placessidebar_save(var);
			break;
		case WIDGET_HEADERBAR:
			widget_headerbar_save(var);
			break;
		case WIDGET_POPOVER:
			widget_popover_save(var);
			break;
		case WIDGET_POPOVERMENU:
			widget_popover_save(var);
			break;
		case WIDGET_MODELBUTTON:
			widget_modelbutton_save(var);
			break;
		case WIDGET_MENUBUTTON:
			widget_menubutton_save(var);
			break;
		case WIDGET_OVERLAY:
		...
		case WIDGET_LEVELBAR:
			...
			break;
		case WIDGET_SEARCHBAR:
			widget_searchbar_save(var);
			break;
		case WIDGET_ACTIONBAR:
			widget_actionbar_save(var);
			break;
		case WIDGET_FILECHOOSERBUTTON:
			widget_filechooserbutton_save(var);
			break;
		case WIDGET_APPCHOOSERBUTTON:
			widget_appchooserbutton_save(var);
			break;
		case WIDGET_APPCHOOSER:
			widget_appchooser_save(var);
			break;
		case WIDGET_APPCHOOSERDIALOG:
			widget_appchooserdialog_save(var);
			break;
		case WIDGET_COLORCHOOSERDIALOG:
			widget_colorchooserdialog_save(var);
			break;
		case WIDGET_FONTCHOOSERDIALOG:
			widget_fontchooserdialog_save(var);
			break;
		case WIDGET_RECENTCHOOSERDIALOG:
			widget_recentchooserdialog_save(var);
			break;
		case WIDGET_SHORTCUTSWINDOW:
		case WIDGET_SHORTCUTSSECTION:
		case WIDGET_SHORTCUTSGROUP:
		case WIDGET_SHORTCUTSSHORTCUT:
			widget_shortcuts_save(var);
			break;
		case WIDGET_FILECHOOSERDIALOG:
...
variable *variables_refresh_widget(variable *registry_var)
{
	...
	switch (var->Type) {
		...
		case WIDGET_STACKSWITCHER:
			widget_stackswitcher_refresh(var);
			break;
		case WIDGET_STACKSIDEBAR:
			widget_stacksidebar_refresh(var);
			break;
		case WIDGET_LISTBOX:
			widget_listbox_refresh(var);
			break;
		case WIDGET_FLOWBOX:
			widget_flowbox_refresh(var);
			break;
		case WIDGET_PLACESSIDEBAR:
			widget_placessidebar_refresh(var);
			break;
		case WIDGET_HEADERBAR:
			widget_headerbar_refresh(var);
			break;
		case WIDGET_POPOVER:
			widget_popover_refresh(var);
			break;
		case WIDGET_POPOVERMENU:
			widget_popover_refresh(var);
			break;
		case WIDGET_MODELBUTTON:
			widget_modelbutton_refresh(var);
			break;
		case WIDGET_MENUBUTTON:
			widget_menubutton_refresh(var);
			break;
		case WIDGET_OVERLAY:
		...
		case WIDGET_LEVELBAR:
			...
			break;
		case WIDGET_SEARCHBAR:
			widget_searchbar_refresh(var);
			break;
		case WIDGET_ACTIONBAR:
			widget_actionbar_refresh(var);
			break;
		case WIDGET_FILECHOOSERBUTTON:
			widget_filechooserbutton_refresh(var);
			break;
		case WIDGET_APPCHOOSERBUTTON:
			widget_appchooserbutton_refresh(var);
			break;
		case WIDGET_APPCHOOSER:
			widget_appchooser_refresh(var);
			break;
		case WIDGET_APPCHOOSERDIALOG:
			widget_appchooserdialog_refresh(var);
			break;
		case WIDGET_COLORCHOOSERDIALOG:
			widget_colorchooserdialog_refresh(var);
			break;
		case WIDGET_FONTCHOOSERDIALOG:
			widget_fontchooserdialog_refresh(var);
			break;
		case WIDGET_RECENTCHOOSERDIALOG:
			widget_recentchooserdialog_refresh(var);
			break;
		case WIDGET_SHORTCUTSWINDOW:
		case WIDGET_SHORTCUTSSECTION:
		case WIDGET_SHORTCUTSGROUP:
		case WIDGET_SHORTCUTSSHORTCUT:
			widget_shortcuts_refresh(var);
			break;
		case WIDGET_FILECHOOSERDIALOG:
...
variable *variables_activate(const char *name)
{
	...
	if (GTK_IS_RADIO_BUTTON(var->Widget)) {
		...
		retval = TRUE;
	} else if (GTK_IS_REVEALER(var->Widget)) {
		gtk_revealer_set_reveal_child(GTK_REVEALER(var->Widget),
			!gtk_revealer_get_reveal_child(GTK_REVEALER(var->Widget)));
		retval = TRUE;
	} else if (GTK_IS_SEARCH_BAR(var->Widget)) {
		gtk_search_bar_set_search_mode(GTK_SEARCH_BAR(var->Widget),
			!gtk_search_bar_get_search_mode(GTK_SEARCH_BAR(var->Widget)));
		retval = TRUE;
	} else if (GTK_IS_SWITCH(var->Widget)) {
		gtk_switch_set_active(GTK_SWITCH(var->Widget),
			!gtk_switch_get_active(GTK_SWITCH(var->Widget)));
		retval = TRUE;
...
static void _variables_export(variable *actual)
{
	...
	if ((actual->Type == WIDGET_ABOUTDIALOG ||
		...
		actual->Type == WIDGET_APPCHOOSERDIALOG ||
		actual->Type == WIDGET_COLORCHOOSERDIALOG ||
		actual->Type == WIDGET_FONTCHOOSERDIALOG ||
		actual->Type == WIDGET_RECENTCHOOSERDIALOG ||
...
variable *variables_clear(const char *name)
{
	...
	switch (toclear->Type) {
		...
		case WIDGET_STACK:
			...
			break;
		case WIDGET_LISTBOX:
			widget_listbox_clear(toclear);
			break;
		case WIDGET_FLOWBOX:
			widget_flowbox_clear(toclear);
			break;
		case WIDGET_PLACESSIDEBAR:
			widget_placessidebar_clear(toclear);
			break;
		case WIDGET_HEADERBAR:
			widget_headerbar_clear(toclear);
			break;
		case WIDGET_POPOVER:
			widget_popover_clear(toclear);
			break;
		case WIDGET_POPOVERMENU:
			widget_popover_clear(toclear);
			break;
		case WIDGET_MODELBUTTON:
			widget_modelbutton_clear(toclear);
			break;
		case WIDGET_MENUBUTTON:
			widget_menubutton_clear(toclear);
			break;
		case WIDGET_OVERLAY:
		...
		case WIDGET_LEVELBAR:
			...
			break;
		case WIDGET_SEARCHBAR:
			widget_searchbar_clear(toclear);
			break;
		case WIDGET_ACTIONBAR:
			widget_actionbar_clear(toclear);
			break;
		case WIDGET_FILECHOOSERBUTTON:
			widget_filechooserbutton_clear(toclear);
			break;
		case WIDGET_APPCHOOSERBUTTON:
			widget_appchooserbutton_clear(toclear);
			break;
		case WIDGET_APPCHOOSER:
			widget_appchooser_clear(toclear);
			break;
		case WIDGET_APPCHOOSERDIALOG:
			widget_appchooserdialog_clear(toclear);
			break;
		case WIDGET_COLORCHOOSERDIALOG:
			widget_colorchooserdialog_clear(toclear);
			break;
		case WIDGET_FONTCHOOSERDIALOG:
			widget_fontchooserdialog_clear(toclear);
			break;
		case WIDGET_RECENTCHOOSERDIALOG:
			widget_recentchooserdialog_clear(toclear);
			break;
		case WIDGET_SHORTCUTSWINDOW:
		case WIDGET_SHORTCUTSSECTION:
		case WIDGET_SHORTCUTSGROUP:
		case WIDGET_SHORTCUTSSHORTCUT:
			widget_shortcuts_clear(toclear);
			break;
		case WIDGET_FILECHOOSERDIALOG:
...
int remove_selected_variable(const char *name)
{
	...
	switch (toclear->Type) {
		...
		case WIDGET_STACK:
			...
			break;
		case WIDGET_LISTBOX:
			widget_listbox_removeselected(toclear);
			break;
		case WIDGET_FLOWBOX:
			widget_flowbox_removeselected(toclear);
			break;
		case WIDGET_PLACESSIDEBAR:
			widget_placessidebar_removeselected(toclear);
			break;
		case WIDGET_HEADERBAR:
			widget_headerbar_removeselected(toclear);
			break;
		case WIDGET_POPOVER:
			widget_popover_removeselected(toclear);
			break;
		case WIDGET_POPOVERMENU:
			widget_popover_removeselected(toclear);
			break;
		case WIDGET_MODELBUTTON:
			widget_modelbutton_removeselected(toclear);
			break;
		case WIDGET_MENUBUTTON:
			widget_menubutton_removeselected(toclear);
			break;
		case WIDGET_OVERLAY:
		...
		case WIDGET_LEVELBAR:
			...
			break;
		case WIDGET_SEARCHBAR:
			widget_searchbar_removeselected(toclear);
			break;
		case WIDGET_ACTIONBAR:
			widget_actionbar_removeselected(toclear);
			break;
		case WIDGET_FILECHOOSERBUTTON:
		...
		case WIDGET_APPCHOOSER:
			...
			break;
		case WIDGET_APPCHOOSERDIALOG:
			widget_appchooserdialog_removeselected(toclear);
			break;
		case WIDGET_COLORCHOOSERDIALOG:
			widget_colorchooserdialog_removeselected(toclear);
			break;
		case WIDGET_FONTCHOOSERDIALOG:
			widget_fontchooserdialog_removeselected(toclear);
			break;
		case WIDGET_RECENTCHOOSERDIALOG:
			widget_recentchooserdialog_removeselected(toclear);
			break;
		case WIDGET_SHORTCUTSWINDOW:
		case WIDGET_SHORTCUTSSECTION:
		case WIDGET_SHORTCUTSGROUP:
		case WIDGET_SHORTCUTSSHORTCUT:
			widget_shortcuts_removeselected(toclear);
			break;
		case WIDGET_FILECHOOSERDIALOG:
