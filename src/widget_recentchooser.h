...
void widget_recentchooser_select(GtkWidget *widget, const gchar *value);
void widget_recentchooser_add_filter(GtkWidget *widget, tag_attr *attr);
void widget_recentchooser_enable_pending_selection(GtkWidget *widget);
